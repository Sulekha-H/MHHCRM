  ...
  const handleSubmit = async (repairData) => {
    try {
      ...
      const formattedRepairData = {
        "Title": repairData.title || repairData.Title,
        "Property ID": repairData.property_id || repairData.Property_Id,
        "Accommodation ID": repairData.accommodation_id || repairData.Accommodation_Id || null,
        "Common Area": transformCommonArea(repairData.common_area || repairData.Common_Area),
        "Repair Type": transformRepairType(repairData.repair_type || repairData.Repair_Type),
        "Priority": transformPriority(repairData.priority || repairData.Priority),
        "Status": transformStatus(repairData.status || repairData.Status),
        "Description": repairData.description || repairData.Description || null,
        "Reported By": repairData.reported_by || repairData.Reported_By,
        "Reported By Type": transformReportedByType(repairData.reported_by_type || repairData.Reported_By_Type),
        "Logged By": repairData.logged_by || repairData.Logged_By || null,
        "Reported on Fiixit": transformFiixitValue(repairData.reported_on_fiixit || repairData.Reported_On_Fiixit),
        "Fiixit Updated": transformFiixitValue(repairData.fiixit_updated || repairData.Fiixit_Updated),
        "Reported Date": repairData.reported_date || repairData.Reported_Date,
        "Assessed Date": repairData.assessed_date || repairData.Assessed_Date || null,
        "Scheduled Date": repairData.scheduled_date || repairData.Scheduled_Date || null,
        "In Progress Date": repairData.in_progress_date || repairData.In_Progress_Date || null,
        "Completed Date": repairData.completed_date || repairData.Completed_Date || null,
        "Date Fixed": repairData.date_fixed || repairData.Date_Fixed || null,
        "Is Cancelled": repairData.is_cancelled ?? repairData.Is_Cancelled,
        "Cancellation Reason": repairData.cancellation_reason || repairData.Cancellation_Reason || null,
        "Cancelled Date": repairData.cancelled_date || repairData.Cancelled_Date || null,
        "Contractor": repairData.contractor || repairData.Contractor || null,
        "Contractor Contact": repairData.contractor_contact || repairData.Contractor_Contact || null,
        "Estimated Cost": repairData.estimated_cost ?? repairData.Estimated_Cost,
        "Invoice Not Applicable": repairData.invoice_not_applicable ?? repairData.Invoice_Not_Applicable,
        "Invoice Received Date": repairData.invoice_received_date || repairData.Invoice_Received_Date || null,
        "Invoice Received From": repairData.invoice_received_from || repairData.Invoice_Received_From || null,
        "Invoice Amount": repairData.invoice_amount ?? repairData.Invoice_Amount,
        "Payment Due Date": repairData.payment_due_date || repairData.Payment_Due_Date || null,
        "Date Invoice Paid": repairData.date_invoice_paid || repairData.Date_Invoice_Paid || null,
        "Invoice Number": repairData.invoice_number || repairData.Invoice_Number || null,
        "Invoice Payment Status": transformInvoicePaymentStatus(repairData.invoice_payment_status || repairData.Invoice_Payment_Status),
        "Invoice File URL": repairData.invoice_file_url || repairData.Invoice_File_Url || null,
        "Notes": repairData.notes || repairData.Notes || null,
        "Images": repairData.images || repairData.Images || [],
        "Updated Date": repairData.updated_date || repairData.Updated_Date
      };
