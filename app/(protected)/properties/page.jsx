...
export default function Properties() {
  ...
  const exportToCSV = () => {
    ...
    const headers = [
      ...
      "Google Drive Link",
      "Bathroom Image Link",
      "Communal Area Image Link",
      "Kitchen Image Link",
      "Garden Image Link",
      "Living Room Image Link",
      "Exterior Image Link",
      "Status",
      "Notes",
      "Created Date",
    ...
    const rows = filteredProperties.map(property => [
      ...
      property["Google Drive Link"] || property.google_drive_link || "",
      property["Bathroom Image Link"] || property.bathroom_image_link || "",
      property["Communal Area Image Link"] || property.communal_area_image_link || "",
      property["Kitchen Image Link"] || property.kitchen_image_link || "",
      property["Garden Image Link"] || property.garden_image_link || "",
      property["Living Room Image Link"] || property.living_room_image_link || "",
      property["Exterior Image Link"] || property.exterior_image_link || "",
