...
export default function AllocatedResidentForm({ resident, accommodations, allocatedResidents, otherResidents, onSubmit, onCancel }) {
  ...
  const [formData, setFormData] = useState({
    ...
    "Sign Up Pack Link": "", "Photo ID URL": "", "Future Address": "", "Future Housing Type": "",
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div><Label>Sign Up Pack Link</Label><Input value={formData["Sign Up Pack Link"]} onChange={(e) => handleChange("Sign Up Pack Link", e.target.value)} /></div>
